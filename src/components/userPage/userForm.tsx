...
const UserForm: React.FC = () => {
  const [type, setType] = useState<"patient" | "secretary" | "doctor">(
    "patient"
  );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await axios.post(
        "http://127.0.0.1:5000/api/v1/auth/login/email",
        payload,
        {
      ...
      if (res.data.token) {
        ...
        Swal.fire({
          icon: "warning",
          title: "مشکل در ورود",
          text: "ورود موفق نبود. توکن دریافت نشد.",
        ...
        <div className="flex w-full max-w-6xl bg-white rounded-lg">
          ...
          <div className="flex-1 p-6 space-y-6 md:mx-4 shadow-lg rounded-3xl sm:mx-8">
            <h2 className="text-2xl font-bold text-blue-700 text-center mb-6">
              خوش آمدید! لطفا وارد حساب خود شوید.
            </h2>
            ...
            <div className="mb-4 flex space-x-4 justify-center border border-gray-400 bg-gray-100 w-[280px] mx-auto py-1 rounded-4xl">
              <button
                ...
                className={`px-5 py-2 rounded-4xl  ${
                  type === "patient"
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p className="text-xs mr-6 text-blue-700 mb-6 cursor-pointer">
              ...
              <div className="text-center">
                ...
                <Link to={"/getOTP"}>
                  <p className="text-sm text-blue-700 mt-4 cursor-pointer">
          ...
          <div className="flex-shrink-0 w-1/2 items-center sm:hidden md:block lg:block hidden">
            <img
              src={photo}
              alt="Doctor"
              className="w-[552px] h-full mx-auto"
            />
          </div>
        </div>
      </div>
